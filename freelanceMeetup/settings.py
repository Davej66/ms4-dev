...
if 'USE_AWS' in os.environ:
    # Cache static files that are not updated regularly
    ...
    # Override static / media URLs in production environment
...
# Stripe
STRIPE_CURRENCY = 'gbp'
STRIPE_PUBLIC_KEY = os.getenv('STRIPE_PUBLIC_KEY_MS4', '')
STRIPE_SECRET_KEY = os.getenv('STRIPE_SECRET_KEY_MS4', '')
